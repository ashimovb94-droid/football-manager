...
const s = StyleSheet.create({
  ...
  formationBtn:        { paddingHorizontal: 16, paddingVertical: 8, borderRadius: 8, backgroundColor: '#12121a', borderWidth: 1, borderColor: '#7b2fff20' },
  ...
  field:               { backgroundColor: '#0d0a1f', borderRadius: 12, overflow: 'hidden', alignSelf: 'center', borderWidth: 2, borderColor: '#7b2fff30' },
  fieldCircle:         { position: 'absolute', width: 80, height: 80, borderRadius: 40, borderWidth: 1, borderColor: '#7b2fff40', top: '50%', left: '50%', marginTop: -40, marginLeft: -40 },
  fieldMidLine:        { position: 'absolute', width: '100%', height: 1, backgroundColor: '#7b2fff40', top: '50%' },
  fieldPenaltyTop:     { position: 'absolute', width: '55%', height: '15%', borderWidth: 1, borderColor: '#7b2fff40', top: 0, left: '22.5%', borderTopWidth: 0 },
  fieldPenaltyBottom:  { position: 'absolute', width: '55%', height: '15%', borderWidth: 1, borderColor: '#7b2fff40', bottom: 0, left: '22.5%', borderBottomWidth: 0 },
  ...
  styleCard:           { backgroundColor: '#12121a', borderRadius: 14, padding: 16, flexDirection: 'row', alignItems: 'center', gap: 14, borderWidth: 1, borderColor: '#7b2fff20' },
  ...
  modal:               { backgroundColor: '#12121a', borderTopLeftRadius: 24, borderTopRightRadius: 24, maxHeight: '70%', borderWidth: 1, borderColor: '#7b2fff20' },
